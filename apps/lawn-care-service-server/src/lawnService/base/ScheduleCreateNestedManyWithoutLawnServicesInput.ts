...
@InputType()
class ScheduleCreateNestedManyWithoutLawnServicesInput {
...
export { ScheduleCreateNestedManyWithoutLawnServicesInput as ScheduleCreateNestedManyWithoutLawnServicesInput };
