...
export class ScheduleResolverBase {
  ...
  async createSchedule(
    ...
    return await this.service.createSchedule({
      ...
      data: {
        ...
        lawnService: args.data.lawnService
          ? {
              connect: args.data.lawnService,
            }
          : undefined,
      },
    });
  ...
  async getClient(@graphql.Parent() parent: Schedule): Promise<Client | null> {
  ...
  @graphql.ResolveField(() => LawnService, {
    nullable: true,
    name: "lawnService",
  })
  async getLawnService(
    @graphql.Parent() parent: Schedule
  ): Promise<LawnService | null> {
    const result = await this.service.getLawnService(parent.id);
